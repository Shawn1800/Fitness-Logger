...
class AuthViewModel(
                            ...
                            .onSuccess {
                                _state.update {
                                    it.copy(
                                        ...
                                        errorMessage = "Account created! We have sent a verification email"
                                    )
                                }
                            }
                            .onFailure { e ->
    ...
    private fun checkUserStatus() {
        ...
        if (user != null) {
            ...
            if (needsVerification) {
                _state.update { it.copy(isWaitingForVerification = true) }
                // We stay on the Login/Signup screen and show the verification UI
            } else {
